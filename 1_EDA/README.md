...
01. [`01_top_demanded_skills.sql`](01_top_demanded_skills.sql) – demand analysis with multi-table joins
02. [`02_top_paying_skills.sql`](02_top_paying_skills.sql) – salary analysis with aggregations
03. [`03_optimal_skills.sql`](03_optimal_skills.sql) – combined demand/salary optimization query  
